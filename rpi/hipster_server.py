...
def serverOp(dataString,verbose=True):
...
#### the function executeCRCommand() is for HIPSTER emulation only
#### It is not used to test HIPSTER hardware


def executeCRCommand():
    """ function that writes to the emulated HIPSTER SPI
    This function is called when CR is written.  Ideally this would be
